...
function MainPage(){
    ...
    useEffect( () => {
        const fetchData = async () => {
            await axios.get('https://best-edu-server.ru/api/user/get-profile-info/', {headers: {'Authorization': `Bearer ${localStorage.getItem('token')}`}})
            .then(response => {
            ...
            await axios.get('https://best-edu-server.ru/api/storage/get-root-dir/', {headers: {'Authorization': `Bearer ${localStorage.getItem('token')}`}})
            .then(response => {
            ...
            await axios.post('https://best-edu-server.ru/api/storage/get-folder-content/', {folder_id: Number(localStorage.getItem('rootDir'))}, {headers: {'Authorization': `Bearer ${localStorage.getItem('token')}`}})
            .then(response => {
    ...
    const getFolderData = (folderId) => {
        axios.post('https://best-edu-server.ru/api/storage/get-folder-content/', {folder_id: folderId}, {headers: {'Authorization': `Bearer ${token}`}})
        .then(response => {
            const files = response.data.files.map(file => (
                {
                    id: file.id,
