...
function ModalFile({file, setTrashFiles, setFiles}) {
    ...
    const fileRemove = () => {
        axios.delete('https://best-edu-server.ru/api/storage/delete-file/', {
            data: {id: file.id},
    ...
    const restoreFile = () => {
        axios.put('https://best-edu-server.ru/api/storage/move-file-from-trash/', {"id": file.id}, {headers: {"Authorization": `Bearer ${token}`}})
        .then(() => {
            setTrashFiles(prev => prev.filter((el) => el.id !== file.id))
        ...
        <div className="file-item">
            ...
            <div className="file-item_item">
                ...
                <div className="file-item_item2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none" onClick={() => fileRemove()}>
                    ...
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => restoreFile()}>
                        <g opacity="0.9">
